...
$lticontainer_chart_view_cap = false;
if (has_capability('mod/lticontainer:chart_view', $mcontext)) {
...
$PAGE->navbar->add(get_string('lticontainer:chart_view', 'mod_lticontainer'));
