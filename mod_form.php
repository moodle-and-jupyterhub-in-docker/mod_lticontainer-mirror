...
class mod_ltids_mod_form extends moodleform_mod {
    ...
    public function definition()
    {
        ...
        $mform->setDefault('imgname_fltr', 'jupyter, ltids');
        ...
        $mform->addElement('text', 'during_realtime', get_string('during_realtime', 'mod_ltids'), array('size' => '12'));
        $mform->addHelpButton('during_realtime', 'during_realtime', 'mod_ltids');
        ...
        $mform->addElement('text', 'during_anytime', get_string('during_anytime', 'mod_ltids'), array('size' => '12'));
        $mform->addHelpButton('during_anytime', 'during_anytime', 'mod_ltids');
