...
$string['use_podman_help'] = 'Select the container system to be used.';
$string['jupyterhub_host'] = 'JupyterHub host and port';
$string['jupyterhub_host_help'] = 'Specify the host name (or IP address) and port number of the JupyterHub in the format "host name:port number". Usually, this "host name" and "Docker/Podman host" are the same. This is used when using the JupyterHub API.';
$string['jupyterhub_ssl'] = 'JupyterHub connection scheme';
$string['jupyterhub_ssl_help'] = 'Specifies whether HTTP or HTTPS is used to connect to JupyterHub. This is used when using the JupyterHub API.';
...
$string['rpc_token'] = 'XML-RPC Token for the Web services';
$string['rpc_token_help'] = 'Specify the <strong>Web services</strong> Token of <strong>Jupyter Notebook Data</strong>. This is used when using the JupyterHub API.';
