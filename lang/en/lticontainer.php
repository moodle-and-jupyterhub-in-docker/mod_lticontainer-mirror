...
$string['jupyterhub_url_help'] = 'Specify the JupyterHub API URL in the format "Protocol_Name://Host_Name[:Port_Number]". However, do not use IP addess for "Host_Name". Please use FQDN as "Host_Name". This is used when using the JupyterHub API.';
